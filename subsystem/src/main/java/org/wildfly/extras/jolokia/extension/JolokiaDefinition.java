 ...
 */
public class JolokiaDefinition extends SimpleResourceDefinition {
    static final JolokiaDefinition INSTANCE = new JolokiaDefinition();

    protected static final SimpleAttributeDefinition JOLOKIA_PORT =
        new SimpleAttributeDefinitionBuilder(JolokiaModel.JOLOKIA_PORT, ModelType.INT, true)
            .setAllowExpression(true)
            .setXmlName(JolokiaModel.JOLOKIA_PORT)
            .setValidator(new IntRangeValidator(0))
            .setFlags(AttributeAccess.Flag.RESTART_ALL_SERVICES)
            .build();

    private JolokiaDefinition() {
        super(PathElement.pathElement(
                ModelDescriptionConstants.SUBSYSTEM, JolokiaExtension.SUBSYSTEM_NAME),
                JolokiaExtension.getResourceDescriptionResolver(JolokiaExtension.SUBSYSTEM_NAME)
        );
    }
    ...
    public void registerOperations(final ManagementResourceRegistration rootResourceRegistration) {
        ...
        final JolokiaSubsystemAdd subsystemAdd = JolokiaSubsystemAdd.INSTANCE;
    ...
    public void registerAttributes(ManagementResourceRegistration resourceRegistration) {
        resourceRegistration.registerReadWriteAttribute(JOLOKIA_PORT, null, new ReloadRequiredWriteAttributeHandler());
    }
}